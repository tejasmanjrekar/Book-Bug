      ...
      authServices
        ...
        .then((data) => {
          ...
          if (data.data.success) {
            //
            if (data.data.data.role.toLowerCase() === "customer") {
            ...
            } else if (data.data.data.role.toLowerCase() === "admin") {
            ...
            } else if (data.data.data.role.toLowerCase() === "seller") {
              localStorage.setItem("Seller_token", data.data.data.token);
              localStorage.setItem("Seller_UserID", data.data.data.userId);
      ...
      <div className="SignIn-Container">
        ...
        <div className="SignIn-Container-Sub">
          <div className="SignUp-SubContainer">
            <div className="Title">Book Selling Mart</div>
